            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input type="radio" name="unit" checked value="goods" id="unit"> <label
                                for="goods">Goods</label>
                            <input type="radio" name="unit" id="unit" value="service"> <label
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <textarea class="form-control" name="purchase_description" id="purchase_description"
                            placeholder="Purchase Description" cols="4" rows="4"></textarea>
                    </div>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="opening_stock_rate_per_unit"
                            id="opening_stock_rate_per_unit">
                    </div>
        ...
        $(document).ready(function() {
            ...
            function addImageToPreview(imageUrl) {
                ...
                var imageElement = $('<div class="preview-image"><img hieght="250em" width="200em" src="' +
                    imageUrl +
                    '" class="img-thumbnail"><span class="remove-button">&times;</span></div>');

                // Append the image element to the container
                previewContainer.append(imageElement);

                // Attach a click event to the remove button
                imageElement.find('.remove-button').on('click', function() {
                    imageElement.remove();
                });
            }
        });
